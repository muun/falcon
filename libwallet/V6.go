...
func CreateAddressV6(userKey, cosignerKey *HDPublicKey) (MuunAddress, error) {
...
func (c *coinV6) signFirstWith(
	...
	cosignerPartialSig, err := musig.ComputeCosignerPartialSignature( //nolint:staticcheck // V6 keeps the deprecated flow
		musig.Musig2v100,
		toSign[:],
