...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let ekPaperPen = ImageAsset(name: "ek_paper_pen")
    internal static let ekQuietPlace = ImageAsset(name: "ek_quiet_place")
    internal static let ekRecoveryCode = ImageAsset(name: "ek_recovery_code")
